...
export const REPORTS: ReportDef[] = [
  ...
  { key: 'finance', to: '/finans/raporlar', title: 'Tahsilat, gelir-gider ve alacak', icon: Wallet, permissions: ['reports.view', 'reports.finance'],
    description: 'Dönemdeki tahsilat, gelir-gider, tahsilat oranı, ödeme yöntemleri ve alacak yaşlandırması. Finans > Finans raporları sayfasında açılır.' },
  { key: 'finance-analytics', to: '/raporlar/finans-analiz', title: 'Finans ve muhasebe analizleri', icon: Landmark, permissions: ['reports.view', 'reports.finance'],
    description: 'Gelir tablosu, nakit akışı, tahsilat performansı, yaşlandırma, fatura/KDV özeti ve program kârlılığı. Mizan ve yevmiye Finans > Muhasebe sayfasındadır.' },
  { key: 'exams', to: '/sinav-sonuclari', title: 'Sınav sonuçları özeti', icon: GraduationCap, permissions: ['reports.view', 'exams.view'],
    description: 'Seçilen sınavda sınıf ortalamaları ve öğrenci sıralaması. Sınavlar > Sonuçlar sayfasında açılır.' },
