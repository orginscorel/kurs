...
export default {
  ...
  commands: [
    ...
    { id: 'attendance-devices', label: 'Yoklama terminalleri', to: '/yoklama/cihazlar', icon: ScanLine, permission: 'devices.manage', hint: 'Yoklama', keywords: ['cihaz', 'terminal', 'parmak izi', 'kart', 'jeton', 'qr'] },
