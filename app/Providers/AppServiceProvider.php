...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        Relation::enforceMorphMap([
            ...
            'coaching_assignment' => \App\Models\CoachingAssignment::class,
            'coaching_session' => \App\Models\CoachingSession::class,
            'coaching_plan' => \App\Models\CoachingPlan::class,
            'coaching_plan_item' => \App\Models\CoachingPlanItem::class,
